...
if(isset($_GET['edit'])){
  $edit_id = $_GET['edit'];
  $edit_query = "SELECT * from tblemployee where Employee_Number='$edit_id'";

  $run_edit = mysql_query($edit_query);

  while($row=mysql_fetch_array($run_edit)){
        $employeenum = $row['Employee_Number'];
        $_SESSION['employeenum'] = $employeenum;
...
<form method="post" enctype="multipart/form-data">
 <?php
  include('edit_facultyprocess.php');
 ?>
<div class="linkes">
...
<table width="30%" border="0" class="aboutstudent2">
	...
	<td width="50%"><select name="gender" value="<?php echo $gender; ?>" required>
		<option>-</option>
		<?php
			if($gender =='Male'){
...
<div id="picture">
	...
	<img src="images/<?php echo $employee_image; ?>" width="200px" height="200px" id="prevpic">
	<img src="images/<?php echo $employee_image; ?>" width="100px" height="100px" id="prevpic">
	<img src="images/<?php echo $employee_image; ?>" width="50px" height="50px" id="prevpic">
