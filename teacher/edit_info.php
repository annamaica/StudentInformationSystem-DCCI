...
<?php
	include('../admin/includes/connection.php');
				...
				$a= mysql_query("SELECT * FROM tblemployee where Employee_Number = '$edit_id'");
...
<?php
    ...
    {
      $update_query = "UPDATE tblemployee set Last_Name='$newlastname',First_Name='$newfirstname',Middle_Name='$newmiddlename',Street='$newstreet',Barangay='$newbarangay',Municipality='$newmunicipality',District='$newdistrict',Province='$newprovince',Contact_Number='$newcontactnum',Email_Address='$newemailadd',Gender='$newgender',Date_of_Birth='$newdob',Age='$newage',Civil_Status='$newcivilstatus'where Employee_Number='$update_id'";
