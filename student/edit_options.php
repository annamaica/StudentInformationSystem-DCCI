...
<h2>Edit</h2>
	Select what you want to edit: <br>

	<a href="edit_picture.php?account=<?php echo $id; ?>" class="pic">Picture</a><br>
	<a href="edit_info.php?account=<?php echo $id; ?>" class="info">Information</a><br>
	<a href="account_settings.php?account=<?php echo $id; ?>" class="settings">Settings</a>
</div>
